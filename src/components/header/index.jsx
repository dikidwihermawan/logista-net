...
function Header() {
  ...
  return (
    <>
      <div className="bg-[#FFFFFF] sticky top-0 max-w-screen-2xl flex flex-wrap items-center justify-between shadow-sm mx-auto p-4 md:px-24 md:py-4 border-b border-b-gray-300 z-10">
        <button
          onClick={() => handleClickScroll("home")}
          className="flex items-center space-x-3 rtl:space-x-reverse"
        >
          <img src="./assets/logo.jpeg" className="h-8" alt="Flowbite Logo" />
