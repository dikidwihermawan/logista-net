...
function index() {
  ...
  return (
    <>
      ...
      <section
        className="max-w-screen-2xl mx-auto h-full md:h-[620px] bg-cover bg-no-repeat bg-[url('./assets/background/section4.png')]"
        id="penawaran"
      >
        <h1 className="text-2xl md:text-4xl font-extrabold tracking-tight leading-none antialiased text-center text-[#1D214E] pt-24">
          Paket yang tersedia
      ...
      <section
        className="max-w-screen-2xl mx-auto h-full md:h-[500px] bg-cover bg-no-repeat bg-[url('./assets/background/section5.png')]"
        id="kontak"
      >
        <div className="max-w-screen-xl grid grid-cols-1 md:grid-cols-2 items-center justify-between mx-auto py-12 px-4 md:px-24">
          <div className="">
            <div className="px-4 space-y-6">
              ...
              <div className="py-2">
                <div>
                  <button
                    onClick={() => handleClickScroll("layanan")}
                    className="flex items-center rounded-lg w-full md:w-auto md:px-4 text-sm py-2 border border-[#04D7A2] focus:outline-none hover:text-white hover:bg-[#04D7A2] text-[#1D214E]"
                  >
                    <img
          ...
          <div className="py-2 md:w-[500px] md:h-[500px]">
            <img src="./assets/section/contactme.png" alt="character" />
          </div>
        </div>
      </section>
    </>
